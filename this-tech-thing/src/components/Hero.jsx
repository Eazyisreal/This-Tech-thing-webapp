...
export default function Hero() {
    return (
        <> 
            <section className="bg-[#F9F9F9] flex flex-row justify-between items-center sm:pt-[5rem] sm:px-[6.25rem] sm:pb-[7.5rem] p-4 gap-8 sm:gap-16">
                <div className="flex flex-col md:flex-row  justify-between gap-[4rem]">
                    <div className="flex flex-col lg:p-12 items-start gap-8 ">
                        <h2 className="font-semibold font-neue lg:text-6xl w-full text-5xl text-[#191919] sm:leading-[1.3]">
                            Get mentored by <br />
