  ...
  return (
    <section className="bg-[#f9f9f9] flex flex-col justify-center gap-12 lg:px-[7.5rem] px-4 py-20">
      ...
      <div className="flex flex-col w-full lg:flex-row gap-8">
        <div className="flex flex-col lg:w-[31.5%] py-[1.5rem] px-[2.5rem] bg-[#66cca0] gap-[1.7rem] border-[#191919] border-[1.5px] rounded-[.8rem]">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="font-neue font-normal text-opacity-50 text-base leading-[1.8] lg:leading-[2] tracking-[0.005em]">
              If you're a designer that has worked on at least one live project
              and you’re looking to give back to the community, simply fill out
              our application form to get started.
            </p>
          </div>
        </div>
        <div className="flex flex-col lg:w-[31.5%] py-[1.5rem] px-[2.5rem] bg-[#f1f1f1] gap-[1.7rem] border-[#191919] border-[1.5px] rounded-[.8rem]">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="font-neue font-normal text-base leading-[1.8] lg:leading-[2] tracking-[0.005em]">
              ...
              application and pair you with a mentee whose your goals and
              aspirations align with your skills and experience.
            </p>
          </div>
        </div>
        <div className="flex flex-col lg:w-[31.5%] py-[1.5rem] px-[2.5rem] bg-[#7db6ee] gap-[1.7rem] border-[#191919] border-[1.5px] rounded-[.8rem]">
          <img
            className="lg:w-[6rem] w-[4rem]"
            loading="lazy"
            src={Schedule}
            alt=""
          />
      ...
      <div className="flex button2 self-center pr-2 pb-2  justify-center items-center">
        <a href="">
          <button className="button whitespace-nowrap">Become a Mentor</button>
        </a>
      </div>
    </section>
  );
