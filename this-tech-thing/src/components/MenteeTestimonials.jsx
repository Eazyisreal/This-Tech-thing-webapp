...
export default function MenteeTestimonials() {
  const duplicatedTestimonials = [...testimonials, ...testimonials];
  return (
    <>
      <section className="bg-[#191919] flex flex-col lg:p-[7.5rem] gap-[1.5rem] py-20 px-4">
        <div className="flex justify-center pb-8">
          <h2 className="font-neue font-normal text-4xl md:text-5xl leading-[1.5] text-center items-center text-[#f5f5f5]">
            Hear from our past mentees about their experience in the program
          </h2>
        </div>
          ...
          >
            {duplicatedTestimonials.map((testimonial, index) => (
              <SwiperSlide key={index} className="swiper-slide">
                <div className=" bg-[#7Db6EE] p-12 rounded-lg">
