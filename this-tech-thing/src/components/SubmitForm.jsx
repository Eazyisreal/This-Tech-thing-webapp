                    ...
                    <div className="flex flex-col items-start gap-4">
                        <div className="flex gap-2">
                            ...
                            <div className="flex flex-col w-full items-start gap-4">
                                <h2 className="w-full text-4xl font-neue font-normal text-[#191919] leading-[1.3] tracking-[0.005em]">
                                    Thank you for your interest in This <br />
                                     Tech Thing mentorship!
                                </h2>
                                <p className="font-neue font-normal text-base tracking-[0.05em] ">
                                We will be in touch soon! In the meantime, follow us on <a className="underline text-xl font-neue " href="https://twitter.com/ttechthing">Twitter</a> and get <br />
